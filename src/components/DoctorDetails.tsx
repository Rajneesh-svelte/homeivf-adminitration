...
const DoctorDetails = ({ selectedId }: any) => {
  ...
  return (
    <div className="flex flex-col h-[70vh] overflow-y-auto rounded-xl bg-gray-300/25 p-2 space-y-2 backdrop-blur-xl shadow-xl transition-all duration-300">
      <div className="bg-card rounded-xl shadow-sm border border-border p-6">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            <div className="relative shrink-0">
              {doctorData.profile_picture ? (
                ...
                <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-primary-100 dark:bg-primary-800 flex items-center justify-center text-gray-400 font-bold text-3xl shadow-md border-4 border-primary-600">
          ...
          <div className="flex flex-wrap gap-4 w-full lg:w-auto">
            ...
            <div className="flex-1 lg:flex-none flex flex-col items-center justify-center bg-primary-50 dark:bg-primary-800/50 rounded-xl p-4 border border-primary-100 dark:border-primary-800 min-w-[120px]">
              <div className="flex items-center gap-1 text-primary-900 font-bold text-lg">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-1 gap-2">
        <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center py-2 border-b border-gray-50 /50 last:border-0 gap-2 sm:gap-0">
              <div className="w-10 h-10 rounded-lg bg-primary-50 dark:bg-primary-900/20 flex items-center justify-center mr-4 shrink-0 hidden sm:flex">
          ...
          <div className="p-6">
            <ul className="space-y-4">
              ...
              <li className="grid grid-cols-3 items-center">
                ...
                <span className="text-sm text-foreground col-span-2 flex items-center">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-1 gap-2">
        <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden flex flex-col">
          <div className="px-6 py-4 border-b border-border flex items-center gap-2">
            ...
            <h3 className="font-semibold text-foreground">Assigned Counselor</h3>
          </div>
        ...
        <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden flex flex-col">
          <div className="px-6 py-4 border-b border-border flex items-center gap-2">
            ...
            <h3 className="font-semibold text-foreground">ART Treatments (IDs)</h3>
          </div>
      ...
      <div className="bg-card rounded-xl shadow-sm border border-border">
        <div className="px-6 py-4 border-b border-border flex items-center gap-2">
          ...
          <h3 className="font-semibold text-foreground">Documents & Signatures</h3>
        </div>
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
          {doctorData.signature && (
            <div className="flex flex-col gap-2">
              ...
              <div className="border border-border rounded-lg p-2 bg-background flex items-center justify-center min-h-[100px]">
                <Image
                  width={150}
                  height={80}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2">
                {doctorData.doctor_certificate.map((cert: any, idx: number) => (
                  <div
                    key={idx}
                    className="border border-border rounded-lg p-3 bg-background text-sm text-gray-700 flex items-center gap-2"
                  >
