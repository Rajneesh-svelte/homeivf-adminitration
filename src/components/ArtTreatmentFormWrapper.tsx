  ...
  return (
    <>
      <div className="flex gap-2 ">
        <div className=" p-6 border    border-gray-200 dark:border-gray-800 rounded-2xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl shadow-xl transition-all duration-300">
          ...
          <div className="grid grid-cols-1  gap-4 h-[50vh] overflow-auto">
            {artTreatment.map((art) => (
              <div
                key={art.id}
                className="group p-4 bg-white dark:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200 ease-in-out cursor-pointer hover:-translate-y-1"
              >
        ...
        <div className="p-6 bg-white/60 flex-1 rounded-2xl border border-gray-200 dark:border-gray-800   dark:bg-gray-900/60 backdrop-blur-xl shadow-xl ">
          <DynamicForm
